...
submit.addEventListener('click',()=>{
   ...
   if(checkedAnswer==0){
        ...
        showProblem.innerHTML=`<button class="btn" onclick="location.reload()">Give Test Again </button><button class="btn" onclick="window.location.href='./solution1.html'">See Solutions</button> <br> <br> `
