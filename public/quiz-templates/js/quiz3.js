...
submit.addEventListener('click',()=>{
    ...
    if(checkedAnswer==1){
        ...
        showProblem.innerHTML=`<button class="btn" onclick="location.reload()">Give Test Again </button> <br> <button class="btn" onclick="window.location.href='./solution3.html'">See Solutions</button> <br>`
