...
submit.addEventListener('click',()=>{
   ...
   if(checkedAnswer==0){
    ...
    // }
        ...
        // }
        showProblem.innerHTML=`<button class="btn" onclick="location.reload()">Give Test Again </button> <br> <button class="btn" onclick="window.location.href='./solution5.html'">See Solutions</button> <br>`
